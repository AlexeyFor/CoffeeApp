...
<div class="content">
	<div class="container">
		...
		<form action="${editRecipeStep2Url}" method="POST">
			...
			<input type="hidden" name="wasCreated" id="wasCreated" value="false">
			...
			: <input type="text" id="infusionsNumber" name="infusionsNumber"
				required pattern="^[1-9]{1}[0-9]{0,1}$" value="${infusionsNumber}">
		...
		<div class="row">
						...
						<li class="page-item">
							...
							<form action="${showAllCoffeeTypeUrl}" method="POST">
								<input type="hidden" name="infusionsNumber" id="infusionsNumber"
									...
									name="recipeId" id="recipeId" value="${recipeId}"> <input
									type="hidden" name="startPosition" id="startPosition"
									value="${page[1]}"> <input type="hidden" name="number"
									id="number" value="10"> <input type="hidden"
									name="sortType" id="sortType" value="${sortType}">
			...
			current page: ${startPositionSelected}
					</c:if>
			</div>
			<div class="col-md-4">
