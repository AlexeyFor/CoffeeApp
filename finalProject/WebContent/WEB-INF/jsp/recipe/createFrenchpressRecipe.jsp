...
<div class="content">
	<div class="container">
		<h3 class="display-5">
			<fmt:message key="${CreateRecipeFrenchpress.head}"></fmt:message>
		</h3>

<!-- 		<h3> -->
<%-- 			<fmt:message key="${message}"></fmt:message> --%>
<!-- 		</h3> -->
<%-- 		<c:url value="/jsp/recipe/createRecipeDone.html" --%>
<%-- 			var="createRecipeDoneUrl" /> --%>
<%-- 		<form action="${createRecipeDoneUrl}"> --%>
